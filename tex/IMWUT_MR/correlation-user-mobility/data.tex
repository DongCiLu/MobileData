...
\change{(M1) Our dataset contains mobile data access history of all active users (during a Sunday evening from 6 pm to 9 pm)
...
\change{Since the locations of cell towers are known, we illustrate the tower locations on a map.
