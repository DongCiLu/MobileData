...
\change{possible other applications:}
...
\change{We briefly evaluate our speed estimation algorithm in Section~\ref{evaluation}.}
Section~\ref{experiments} explains our findings on the correlation of user speeds and mobile data access patterns.
\change{We state the limitations of our work in Section~\ref{evaluation}.}
