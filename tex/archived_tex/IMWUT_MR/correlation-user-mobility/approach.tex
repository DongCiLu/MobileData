...
\begin{algorithm}
 \KwData{$Trace$: \change{mobile data trace arranged by users $u$ with record entries $e$ sorted by time. Each $e$ has location estimate $l_e$ and timestamp $t_e$. We use $l_c$ to represent location of current entry.} }
